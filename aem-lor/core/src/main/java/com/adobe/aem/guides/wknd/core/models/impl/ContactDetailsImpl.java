...
import com.adobe.aem.guides.wknd.core.models.ContactDetails;
import com.adobe.cq.wcm.core.components.models.Image;

@Model(
        adaptables = {SlingHttpServletRequest.class},
        adapters = {ContactDetails.class},
        resourceType = {ContactDetailsImpl.RESOURCE_TYPE},
        defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL
)
public class ContactDetailsImpl implements ContactDetails {
    protected static final String RESOURCE_TYPE = "lor/components/contactdetails";
